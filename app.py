...
<div class="hero-block" style="background: #0b1020; padding: 2.25rem 2.25rem; border-radius: 16px; border: 1px solid #1b223c; margin-bottom: 2rem;">
  <span style="color: #7dd3fc; font-size: 0.72rem; font-weight: 700; text-transform: uppercase; letter-spacing: 1.5px;">Computational pharmacology &middot; Physics-informed ML</span>
  ...
  <p style="font-size: 1.05rem; color: #94a3b8; max-width: 820px; line-height: 1.6; margin: 0 0 1.25rem 0;">
    ...
    (not clinical or reactor assay data).
  </p>
  <div style="display: flex; gap: 0.6rem; flex-wrap: wrap;">
    <span class="hero-pill" style="background: rgba(16, 185, 129, 0.12); border: 1px solid rgba(16, 185, 129, 0.3); border-radius: 6px; padding: 0.3rem 0.8rem; font-size: 0.78rem; font-weight: 600; color: #6ee7b7;">6/6 validation checks &middot; ~4.5% held-out Ac-225 vs ODE</span>
  </div>
</div>
""", unsafe_allow_html=True)
